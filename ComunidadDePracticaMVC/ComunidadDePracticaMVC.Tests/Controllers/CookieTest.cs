...
namespace ComunidadDePracticaMVC.Tests.Controllers
{
    ...
    public class CookieTest
    {
        ...
        public void CookieTest_UserCoordinador_ReturnTrue() {
            ...
            bool resultado = Models.CookieHandler.AuthorizeRole(auth, "Coordinador");
        ...
        {
            System.Web.HttpCookie auth = CookieTestController.CreateCookieDummy("Coordinador");
            bool resultado = Models.CookieHandler.AuthorizeRole(auth, "Nucleo");
        ...
        {
            System.Web.HttpCookie auth = CookieTestController.CreateCookieDummy("Coordinador");
            bool resultado = Models.CookieHandler.AuthorizeRole(auth, "Coordinador,Nucleo,Prueba,Prueba2");
            Assert.IsTrue(resultado);
        }
        ...
        {
            System.Web.HttpCookie auth = CookieTestController.CreateCookieDummy("Coordinador");
            bool resultado = Models.CookieHandler.AuthorizeRole(auth, "Nucleo,Prueba,Prueba2,Periferico");
            Assert.IsFalse(resultado);
        }
        ...
        {
            System.Web.HttpCookie auth = CookieTestController.CreateCookieDummy("Nucleo");
            bool resultado = Models.CookieHandler.AuthorizeRole(auth, "Nucleo,Coordinador,Periferico,Prueba2");
            Assert.IsTrue(resultado);
        }
        ...
        {
            System.Web.HttpCookie auth = CookieTestController.CreateCookieDummy("Nucleo");
            bool resultado = Models.CookieHandler.AuthorizeRole(auth, "Coordinador,Prueba,Prueba2,Periferico");
            Assert.IsFalse(resultado);
        }
        ...
        public void CookieTest_UserPeriferico_ReturnTrue()
        {
            ...
            bool resultado = Models.CookieHandler.AuthorizeRole(auth, "Periferico");
            Assert.IsTrue(resultado);
        }
        ...
        {
            System.Web.HttpCookie auth = CookieTestController.CreateCookieDummy("Periferico");
            bool resultado = Models.CookieHandler.AuthorizeRole(auth, "Coordinador,Nucleo,Prueba,Periferico");
            Assert.IsTrue(resultado);
        }
        ...
        {
            System.Web.HttpCookie auth = CookieTestController.CreateCookieDummy("Periferico");
            bool resultado = Models.CookieHandler.AuthorizeRole(auth, "Nucleo,Prueba,Prueba2,Coordinador");
            Assert.IsFalse(resultado);
        }
    }
}
